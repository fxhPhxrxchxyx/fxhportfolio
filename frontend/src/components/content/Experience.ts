...
export const experience: Exprience[] = [
  ...
  },
  {
    ...
    time: "OCT-NOV 2021",
    description:
      "Leader font-end team use reactJs, js, html, css, bootstrap-React language for create bedtime story for children. Also got 1st champ and the Best front-end award.",
  },
];
...
export const activity: Exprience[] = [
  {
    ...
    time: "12-14 January 2024",
    description:
      "As an Academic Mentor at the Junior Programmer Camp, I taught high school students Python programming, AI chatbot development, Discord bot integration, IoT projects, and network fundamentals. My role involved creating interactive lesson plans and leading practical sessions, particularly focusing on Basic logic, AI chatbots and IoT applications.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    project: "GDSC KMUTT",
    position:
      "Core team (content creator and staff) of Google Developer Student Clubs",
    time: "SEP 2022 - PRESENT",
    description:
      "Create contents about Google services and publish on the facebook page, develop, design and manage event.",
  },
  {
    id: 4,
  ...
  {
    id: 5,
    project: "Volunteer Staff AI For Accessibility Hackathon",
    position: "Microsoft",
    time: "JUNE 2023",
    description:
      "Microsoft Thailand Pitching Day: AI For Accessibility Hackathon. on 7th june 2023 I am a staff who take responsibility take care of the contestants' numerous needs. Also timer for presentation, Q&A.",
  },
  {
    id: 6,
    project: "Staff hackathon cs sit 2023",
    position: "SIT KMUTT",
    time: "MAY 2023",
    description:
      "From May 27th to 28 th, 2023 SIT Hackathon 2023 event aimed to encourage students to apply the knowledge they have acquired to develop and implement solutions for predetermined problems in web application development throughout the duration of the Hackathon. I am a staff who take care of the contestants' numerous needs. suggest solutions, take a picture and edit them.",
  },
  {
    id: 7,
  ...
  {
    id: 9,
    project: "Microsoft Student Ambassador",
    position: "Allpha Student Ambassadors",
